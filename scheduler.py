...
scheduler.add_job(fetch_weather_forecast_range, 'interval', seconds=20, args=[(datetime.datetime.now() + datetime.timedelta(days=1)).strftime('%Y-%m-%d'), (datetime.datetime.now() + datetime.timedelta(days=7)).strftime('%Y-%m-%d')])
